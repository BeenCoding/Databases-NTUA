        ...
        <div class="row my-5">
            <div class="col-md-6 col-xl-4">
                <form method="post" action="/Team7/Project/purchases.jsp">
                    ...
                    <div>
                        <button class="btn btn-success btn-sm pull-right mx-3" type="submit" style="margin: 0px;">
                            Search
                        </button>
                        <br>
                        <br>
                        <p style="color:orange"><sub><b>Tip:</b> By leaving form empty, query retrieves all
                            transactions!</sub></p>
                    </div>
                </form>
            </div>
            ...
            <div class="col-md-6 col-xl-8">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td style="text-align:center"><%=purchase.getDatetime() %>
                            </td>
                            <td style="text-align:center"><%=purchase.getStoreId() %>
                            </td>
                            <td style="text-align:center"><%=purchase.getCardId() %>
                            </td>
                            <td style="text-align:center"><%=purchase.getPaymentMethod()%>
                            </td>
                            <td style="text-align:center"><%=purchase.getTotalPieces() %>
                            </td>
