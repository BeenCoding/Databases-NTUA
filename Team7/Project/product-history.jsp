...
<div class="container col-5">
        <div>
			<div class="row">
                ...
                <div class="col-md-7">
                    <h1 class="display-4 my-5">History of product with ID: <%= barcode %></h1>
                </div>
            </div>
...
<%
					...
					for(History history : allh){ %>
								<tr>
									<td style="text-align:center"><%=history.getStartDate() %></td>
									<td style="text-align:center"><%=history.getPrice() %></td>
									<td style="text-align:center"><%=history.getEndDate() %></td>
									<td style="text-align:center"><%=history.getBarcode() %></td>
								</tr>
                </div>
            </div>
        </div>
