...
<body>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-4 my-5" style="width: 1px;"><a href="add-store-phone.jsp?storeId=<%=storeId%>"><i class="fa fa-chevron-left my-4" style="color: rgb(0,0,0);"></i></a></div>
                <div class="col-md-6">
    ...
    <div class="col-md-5 col-xl-6 offset-xl-4 my-3 align">
        ...
        <div class="row my-4">
            <div class="col"><button type="submit" class="btn btn-success float-right" onclick="return confirm('Insert telephone in shop?');">Submit</button></div>
