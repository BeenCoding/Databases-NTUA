...
<div class="container col-5">
    <div>
        <div class="row">
            ...
            <div class="col-md-7">
                <h1 class="display-4 my-5">Product with ID: <%= barcode %>
                </h1>
            </div>
        </div>

        <div class="row mx-5">
            <div class="col"><a class="btn btn-dark" role="button" href="insert-product-shop.jsp?barcode=<%=barcode%>">Add <%=p.GetName()%>
                in store</a></div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-12 col-xl-10 offset-xl-1">
                <div class="table-responsive my-4">
					...
					for(Offers offer : offers){ %>
                        <tr>
                            <td style="text-align:center"><%=offer.GetShelf() %>
                            </td>
                            <td style="text-align:center"><%=offer.getAlley() %>
                            </td>
                            <td style="text-align:center"> Store <%=offer.GetStoreId() %>
                            </td>
