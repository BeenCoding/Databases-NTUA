...
<body>
    <div class="container">
        <div>
            <nav class="navbar navbar-light navbar-expand-md navigation-clean-search">
                <div class="container col-9 text-center"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
	...
	<div class="topnav float-right">
				<div class="search-container">
					<input type="search" style="height: 50px;text-align: center" placeholder="Search in Sales View.." name="search" id="search">
				</div>
			</div>
		<div class="table-responsive my-4 ">
				...
				<tbody>
					...
					for(Sales sale: sales){ %>
								<tr>
									<td style="text-align:center"> <%=sale.getStore() %></td>
									<td style="text-align:center"> <%=sale.getCategory() %></td>
									<td style="text-align:center"> <%=sale.getCategoryName() %></td>
