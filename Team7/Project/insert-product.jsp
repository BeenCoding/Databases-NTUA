...
<body>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-2 my-5" style="width: 1px;"><a href="products.jsp"><i class="fa fa-chevron-left my-4" style="color: rgb(0,0,0);"></i></a></div>
                <div class="col-md-6">
            ...
            <table>
                <tbody class="text-left text-primary">
                    ...
                    <tr>
                        ...
                        <td><input name = "price" type="number" step="0.01" style="width: 350px;height: 40px;" max="9999.99" required></td>
                    </tr>
                </tbody>
            </table>
        <div class="row my-4">
            <div class="col"><button type="submit" class="btn btn-success float-right" onclick="return confirm('Insert this Product?');">Submit</button></div>
