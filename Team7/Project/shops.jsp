...
<div class="container col-10">
    <div class="row my-4">
        <div class="col"><a class="btn btn-dark" role="button" style="height: 50px;text-align: center"
                            href="insert-shop.jsp">Add Store</a></div>
        <div class="topnav float-right">
            <div class="search-container">
                <input type="search" style="height: 50px;text-align: center" placeholder="Search in Stores.."
    ...
    <div class="table-responsive my-4">
        <table id="editable_table" class="table table-striped">
            ...
            <tr>
                <td style="text-align:center"><%=store.getStoreId() %>
                </td>
                <td style="text-align:center"><%=store.GetOperatingHours() %>
                </td>
                <td style="text-align:center"><%=store.getSize() %> m²</td>
                <td style="text-align:center"><%=store.getStreet() %>
                </td>
                <td style="text-align:center"><%=store.getNumber() %>
                </td>
                <td style="text-align:center"><%=store.getPostal() %>
                </td>
                <td style="text-align:center"><%=store.getCity() %>
                </td>
