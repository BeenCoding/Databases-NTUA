...
<body>
	...
	<div class="row my-4">
				<div class="col"><a class="btn btn-dark text-center" role="button" style="height: 50px;text-align: center" href="insert-client.jsp">Add Client</a></div>
				<div class="topnav float-right">
					<div class="search-container">
						<input type="search" style="height: 50px;text-align: center" placeholder="Search in Clients.." name="search" id="search">
					</div>
				</div>
			</div>
		<div class="table-responsive my-4 ">
				...
				<tbody>
					...
					for(Customer customer : customers){ %>
								<tr>
									<td style="text-align:center"> <%=customer.getCard() %></td>
									<td style="text-align:center"> <%=customer.getPoints() %></td>
									<td style="text-align:center"> <%=customer.getName() %></td>
									<td style="text-align:center"> <%=customer.getDOB() %></td>
									<td style="text-align:center"> <%=customer.getPhone() %></td>
									<td style="text-align:center"> <%=customer.getStreet() %></td>
									<td style="text-align:center"> <%=customer.getNumber() %></td>
									<td style="text-align:center"> <%=customer.getPostal() %></td>
									<td style="text-align:center"> <%=customer.getCity() %></td>
									<td style="text-align:center"> <%=customer.getFamilyMembers() %></td>
									<td style="text-align:center">  <%=customer.getPet() ? "Yes" : "No" %></td>
