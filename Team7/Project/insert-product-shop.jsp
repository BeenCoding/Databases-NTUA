...
<body>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-2 my-5" style="width: 1px;"><a href="add-product-shop.jsp?barcode=<%=barcode%>"><i class="fa fa-chevron-left my-4" style="color: rgb(0,0,0);"></i></a></div>
                <div class="col-md-10">
                    <h2 class="display-4 my-5">Add <%=p.GetName()%> </h2>
                </div>
            </div>
        </div>
    </div>
    <div align="center"><div class= "col-4"> 
            ...
            <table>
                <tbody class="text-left text-primary">
                    <tr>
                        ...
                        <td><input type="number" name = "barcode" value = "<%=barcode%>" style="width: 420px;height: 40px; " readonly></td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        ...
                        <td>
							<select name = "shopid" style="width: 420px;height: 40px;">
								...
								<% 	for(Store s: stores) { %>
									<option value="<%=s.getStoreId() %>"> Shop <%=s.getStoreId() %></option>
								<% 	} %>
								</optgroup>
							</select>
						</td>
        ...
        <div class="row my-4">
            <div class="col"><button type="submit" class="btn btn-success float-right" onclick="return confirm('Insert <%=p.GetName()%> in shop?');">Submit</button></div>
