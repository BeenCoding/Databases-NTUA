                ...
                <div class="col-md-8">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th colspan="2" style="text-align:center"><h5>Most popular products bought together:</h5></th>
                                </tr>
                            </thead>
                            <tbody>
							...
							for(HashMap.Entry<String,String> m : hot_duo.entrySet()){ %>
								<tr>
									<td style="text-align:center"><%=m.getKey() %> </td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
							...
							for(Map.Entry<Integer,List<Integer>> m : hotpos.entrySet()){ %>
								<tr>
									<td style="text-align:center">Store <%=m.getKey() %>  </td>
				...
				<div class="col-md-5 col-xl-5">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th style="text-align:center" colspan="3"><h5>Avg spend per visit based on Family and Pets:</h5></th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="col-md-7 col-xl-7 offset-xl-0">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th style="text-align:center" colspan="4"><h5>Percentage of elderly groups visiting stores:</h5></th>
                                </tr>
                            </thead>
                            <tbody>
							<td style="text-align:center"><b>Hour</b></td>
