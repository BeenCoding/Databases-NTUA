...
<div class="container col-10">
    <div class="row my-4">
        <div class="col"><a class="btn btn-dark text-center" role="button" style="height: 50px;text-align: center"
                            href="insert-product.jsp">Add Product</a></div>
        <div class="topnav float-right">
            <div class="search-container">
                <input type="search" style="height: 50px;text-align: center" placeholder="Search in Products.."
    ...
    <div class="table-responsive my-4">
        <table id="editable_table" class="table table-striped">
            ...
            <tr>
                <td style="text-align:center"><%=product.getBarcode() %>
                </td>
                <td style="text-align:center"><%=product.GetName() %>
                </td>
                <td style="text-align:center"><%=product.getPrice() %> €</td>
                <td style="text-align:center"><%=product.getBrandName() ? "Yes" : "No" %>
                </td>
                <td style="text-align:center"><%=product.getFirstTransaction() %>
                </td>
                <td style="text-align:center"><%=product.getCategoryId() %>
                </td>
                ...
                <td class="text-center">
                    ...
                    <a type="button"
                       href="<%= request.getContextPath() %>/Project/delete-product.jsp?barcode=<%=product.getBarcode() %>"
