...
<body>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-2 my-5" style="width: 1px;"><a href="shops.jsp"><i class="fa fa-chevron-left my-4" style="color: rgb(0,0,0);"></i></a></div>
                <div class="col-md-6">
            ...
            <table>
                <tbody class="text-left text-primary">
					...
					<tr>
                        ...
                        <td><input type="number" name = "ssize" style="width: 350px;height: 40px;" max="99999999999" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="number" min = "1000" max = "9999" name = "spostal" style="width: 350px;height: 40px;"required></td>
                    </tr>
                    <tr>
                        <td class="text-dark">City:</td>
                        <td><input type="text" pattern="^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$" name = "scity" style="width: 350px;height: 40px;" maxlength="45" required></td>
                    </tr>
                    <tr>
                        <td style="color: rgb(0,0,0);">Phone:</td>
                        <td><input type="number" min = "20000000" max ="25999999" name = "sphone" style="width: 350px;height: 40px;"required></td>
                    </tr>
                </tbody>
            </table>
        <div class="row my-4">
            <div class="col"><button type="submit" class="btn btn-success float-right" onclick="return confirm('Insert this Store?');">Submit</button></div>
