            ...
            <div class="row">
						...
						<div class="table-responsive">
							<table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control-plaintext" type="number" name = "customerCard" value ="<%=customer.getCard()%>" readonly ></td>
                                </tr>
                                <tr>
                                    <td style="color: rgb(0,0,0);">Points:</td>
                                    <td><input class="form-control-plaintext" type="number" name = "customerPoints" value ="<%=customer.getPoints()%>"></td>
                                </tr>
                                <tr>
                                    <td style="color: rgb(0,0,0);">Name:</td>
                                    <td><input type="text" pattern="^([ \u00c0-\u01ffa-zA-Z'\-])+$" value ="<%=customer.getName()%>" name = "customerName" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td style="color: rgb(0,0,0);">Date of Birth:</td>
                                    <td><input type="date" value ="<%=customer.getDOB()%>" name = "customerDOB" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td style="color: rgb(0,0,0);">Mobile Number:</td>
                                    <td><input type="number" min = "95000000" max ="99999999" value ="<%=customer.getPhone()%>" name = "customerPhone" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td style="color: rgb(0,0,0);">Street:</td>
                                    <td><input type="text" value ="<%=customer.getStreet()%>" name = "customerStreet" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td class="text-dark">Number:</td>
                                    <td><input type="number" value ="<%=customer.getNumber()%>" name = "customerNumber" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td class="text-dark">Postal Code:</td>
                                    <td><input type="number" min = "1000" max = "9999" value ="<%=customer.getPostal()%>" name = "customerPostal" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td class="text-dark">City:</td>
                                    <td><input type="text" pattern="^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$" value ="<%=customer.getCity()%>" name = "customerCity" style="width: 265px;height: 40px;"></td>
                                </tr>
                                <tr>
                                    <td style="color: rgb(0,0,0);">Family Members:</td>
                                    <td><input type="number" value ="<%=customer.getFamilyMembers()%>" name = "customerFamily" style="width: 265px;height: 40px;"></td>
                                </tr>
								<tr>
							...
							<div class="row pull-right mx-2">
								<div class="col"><button class="btn btn-success float-right" type="submit" onclick="return confirm('Update <%=customer.getName()%>?');">Update</button></div>
								<div class="col"><button class="btn btn-secondary text-left" type="reset" onclick="return confirm('Discard changes?');">Discard</button></div>
							</div>
						</div>
					</form>
                </div>
                <div class="col-4 my-2">
                    <div class="row">
								<div class="col">
								<hr>
                                    <div class="mx-2"><h5> Number of stores client visits: <%=customerdetails.getShopCount()%></h5>  </div>
                                </div>
                            </div>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
								<%
										...
										for(int cdetails : c){ %>
											<tr>
												<td style="text-align:left"> Store <%=cdetails %></td>
											</tr>
									<% 	} 
										if(c.size() == 0) {
										%>		
                            ...
                            <tbody>
                                <%
														...
														for(String pdetails : p){ %>
																	<tr>
																		<td style="text-align:left"><%=pdetails %></td>
																	</tr>
                            ...
                            <tbody>
                                <%
											...
											for(Map.Entry<Integer,Integer> chdetails : ch.entrySet()){ %>
														<tr>
															<td style="text-align:center">Store <%=chdetails.getKey() %> </td>
