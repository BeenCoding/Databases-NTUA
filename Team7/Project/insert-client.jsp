...
<div>
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-xl-2 my-5" style="width: 1px;"><a href="clients.jsp"><i
    ...
    <form class="table table-striped" method="POST" action="/Team7/Project/insert-client-controller.jsp">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" pattern="^([ \u00c0-\u01ffa-zA-Z'\-])+$" name="customerName"
            ...
            <tr>
                ...
                <td><input type="number" min="1000" max="9999" name="customerPostalCode"
                           style="width: 350px;height: 40px;" required></td>
            </tr>
            <tr>
                <td class="text-dark">City:</td>
                <td><input type="text" pattern="^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$" name="customerCity"
                           style="width: 350px;height: 40px;" required></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="number" min="95000000" max="99999999" name="customerTel"
                           style="width: 350px;height: 40px;" required></td>
            </tr>
            </tbody>
        </table>
        <div class="row my-4">
            <div class="col">
                <button type="submit" class="btn btn-success float-right"
                        onclick="return confirm('Insert this Client?');">Submit
                </button>
            </div>
            <div class="col">
