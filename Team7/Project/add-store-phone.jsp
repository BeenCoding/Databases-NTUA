...
<div class="container col-5">
        <div>
			<div class="row">
                <div class="col-md-6 col-xl-3 my-5" style="width: 1px;"><a href="shops.jsp"><i class="fa fa-chevron-left my-4" style="color: rgb(0,0,0);"></i></a></div>
                <div class="col-md-7">
                    <h1 class="display-4 my-5">Store with ID: <%= storeId %></h1>
                </div>
            </div>

            <div class="row mx-5">
                <div class="col"><a class="btn btn-dark" role="button" href="insert-phone-shop.jsp?storeId=<%=storeId%>">Add phone in store</a></div>
            </div>
        </div>
    </div>
...
<%
					...
					for(StorePhones phone : phones){ %>
								<tr>
									<td style="text-align:center">Store <%=phone.getStoreId() %></td>
									<td style="text-align:center"> <%=phone.getPhone() %></td>
