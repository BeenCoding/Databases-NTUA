...
<body>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-xl-2 my-5" style="width: 1px;"><a href="products.jsp"><i class="fa fa-chevron-left my-4" style="color: rgb(0,0,0);"></i></a></div>
                <div class="col-md-8">
                    <h1 class="display-4 my-5">Edit Product with Barcode: <%=barcode%></h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <table>
                <tbody class="text-left text-primary">
                    <tr>
                        ...
                        <td><input type="text" pattern="^[0-9]*$" name = "barcode" value = "<%=p.getBarcode()%>" style="width: 350px;height: 40px;" readonly></td>
                    </tr>
                    <tr>
                        <td class="text-dark">Name:</td>
                        <td><input type="text" name = "name" value = "<%=p.GetName()%>" style="width: 350px;height: 40px;" maxlength="70"></td>
                    </tr>
                    <tr>
                        ...
                        <td>
							<select name = "cat"  style="width: 350px;height: 40px;">
								<optgroup label="-Select an option-">
									...
									<option value="2" <%=(p.getCategoryId() == 2)?"selected":""%> >Refrigerator Products</option>
									<option value="3" <%=(p.getCategoryId() == 3)?"selected":""%> >Liquor Products</option>
									<option value="4" <%=(p.getCategoryId() == 4)?"selected":""%> >Personal Care Products</option>
                    ...
                    <tr>
                        ...
                        <td><input name = "fdate" value = "<%=p.getFirstTransaction()%>" type="date" style="width: 350px;height: 40px;" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input  type="number" step="0.01" name = "price" value = "<%=p.getPrice()%>" style="width: 350px;height: 40px;" max="9999.99" required></td>
                    </tr>
                </tbody>
            </table>
        <div class="row my-4">
            <div class="col"><button type="submit" class="btn btn-success float-right" onclick="return confirm('Update <%=p.GetName()%>?');">Update</button></div>
